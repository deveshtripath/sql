...
def export_menu():
    ...
    while True:
        ...
        if ch == 1:
            df.to_csv('D:\Mysql\IPL_data_analysis/backup/ipl_data_backup.csv')
            print('\n\nCheck your new file "ipl_data_backup.csv"  on C: Drive.....')
            wait = input('\n\n\n Press any key to continuee.....')

        if ch == 2:
            df.to_excel('D:\Mysql\IPL_data_analysis/backup/ipl_data_backup.xlsx')
            print('\n\nCheck your new file "ipl_data_backup.xlsx"  on D: Drive.....')
            wait = input('\n\n\n Press any key to continuee.....')
